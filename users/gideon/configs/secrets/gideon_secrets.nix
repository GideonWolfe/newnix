{ config, ... }: {
  # This file contains the definitions for all my secrets
  # Used by sops-nix to decrypt and place secrets on the system
  sops.secrets = {
    "freshrss/apikey" = {
    ...
    # IMPORTANT! Places private key pointer to Yubikey inside SSH directory
    # SSH and Git Configs expect this key to exist. 
